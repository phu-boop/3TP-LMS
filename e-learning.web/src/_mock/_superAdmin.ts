...
export type SuperAdminTenant = { id: string; code?: string; name: string; subdomain?: string };
...
export const _superAdminUsersInitial: SuperAdminManagedUser[] = [
  ...
  },
  {
    ...
    tenantIds: ['tn-central'],
    tenantNames: ['Sở GD&ĐT Miền Trung'],
    status: 'active',
    createdAt: now,
    updatedAt: now,
  },
